...
public class DijkstraAlgorithmus {
    ...
    private static int anzahlStationen;
    ...
    public static void Initialisierung() {
        ...
        anzahlStationen = ubahnStationen.size();
        ...
        hinzufuegenU_Bahn_Kante(11, 14, 40, "U6"); // Westbahnhof <--> Längenfeldgasse
    ...
    public static void startBerechnung(String startStation, String endStation) {
        ...
        //Redundant, wenn über Main-Methode gestartet
        DijkstraAlgorithmus.Initialisierung();
    ...
    private static void druckeWeg(int startKnoten, int endKnoten) {
        ...
        System.out.println("\nVoller Weg von " + ubahnStationen.get(startKnoten) + " nach " + ubahnStationen.get(endKnoten) + ":");
        for (int i = 0; i < weg.size(); i++) {
    ...
    public static void main(String[] args) {
        ...
        // Initialisierung Linien und Stationen
        DijkstraAlgorithmus.Initialisierung();

        // Eingabeaufforderung für den Benutzer
        System.out.println("Verfügbare U-Bahn-Stationen:");
        for (int i = 0; i < DijkstraAlgorithmus.ubahnStationen.size(); i++) {
            System.out.println((i + 1) + ". " + DijkstraAlgorithmus.ubahnStationen.get(i));
        }

        // Eingabe der Startstation
        Scanner scanner = new Scanner(System.in);
        System.out.print("Geben Sie die Nummer der Startstation ein: ");
        int startNummer = scanner.nextInt();
        String startStation = DijkstraAlgorithmus.ubahnStationen.get(startNummer - 1);

        // Eingabe der Endstation
        System.out.print("Geben Sie die Nummer der Endstation ein: ");
        int endNummer = scanner.nextInt();
        String endStation = DijkstraAlgorithmus.ubahnStationen.get(endNummer - 1);

        scanner.close();

        // Dijkstra-Algorithmus mit den ausgewählten Stationen aufrufen
        DijkstraAlgorithmus.startBerechnung(startStation, endStation);
    }
